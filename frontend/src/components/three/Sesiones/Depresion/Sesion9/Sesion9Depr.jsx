...
/* Esta es la sesion 4.6 y le corresponde el audio sesion6 */
export function Sesion9Depr({ color, PlayerApi, posicionPizarra }) {
    ...
    const changeInfo = () => {
        ...
        setShowInfo((prevIndex) => {
            ...
            if (newIndex === 2) {
                setAudioSesion(document.getElementById('audioSesion9Depr'));
                setShowAudio(true);
            } else if (newIndex === 4) {
                setTextoBoton('¡Vamos allá!');

            } else if (newIndex === 5) {
                navigate('/estoyPresente');
            }
    ...
    return (
        <>
            <Html>
                <audio id="audioSesion9Depr" src={'./AudioSesionesDepr/Sesion1y5.mp3'} />
            </Html>
            ...
            {showInfo === 0 ? (
                < Text position={[-4.95, 2.3, -0.5]} fontSize={0.2} color={'#000000'} maxWidth={5} rotation={[0, Math.PI / 2, 0]}
                    textAlign="justify"
                >
                    Bienvenido/a a la sesión 9 de depresión, a la sexta sesión de Mindfulness. Hoy te enseñaré un método que te ayudará a
                    ser más consciente y enfocar tu atención en las conversaciones que tengas con las personas.
                </Text >
                ...
                < Text position={[-4.95, 2.3, -0.5]} fontSize={0.19} color={'#000000'} maxWidth={5} rotation={[0, Math.PI / 2, 0]}
                    textAlign="justify"
                >
                    La comunicación consciente implica prestar atención plena a las palabras, expresiones y emociones de los demás.
                    Esto también ayuda a mejorar las relaciones interpersonales y disminuir la tensión en situaciones de conflicto.
                </Text >
                ...
                < Text position={[-4.95, 2.3, -0.5]} fontSize={0.2} color={'#000000'} maxWidth={5} rotation={[0, Math.PI / 2, 0]}
                    textAlign="center"
                >
                    Para ello, comenzaremos con una meditación guiada.
                ...
                < Text position={[-4.95, 2.3, -0.5]} fontSize={0.2} color={'#000000'} maxWidth={5} rotation={[0, Math.PI / 2, 0]}
                >
                    Esta meditación, como te habrás dado cuenta, ya la realizaste con anterioridad.
                    Esto es porque el entrenamiento regular de estas meditaciones hará que mejores la técnica de atención plena.
                </Text >
                ...
                < Text position={[-4.95, 2.3, -0.5]} fontSize={0.19} color={'#000000'} maxWidth={5} rotation={[0, Math.PI / 2, 0]}
                    textAlign="justify"
                >
                    Si te parece, vamos a realizar una dinámica para poner a prueba tu atención en las conversaciones.
                </Text >
            )}
